...
LRESULT LoginWindow::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	switch (uMsg)
	{
		case WM_CREATE:
			...
			BT_Google.Create(NULL, WS_CHILD | WS_VISIBLE, NULL, 201,269 , 50, 50, m_hwnd, NULL);
			BT_Center.Create(NULL, WS_CHILD | WS_VISIBLE, NULL, 275, 269, 50, 50, m_hwnd, NULL);
			BT_Telegram.Create(NULL, WS_CHILD | WS_VISIBLE, NULL, 349, 269, 50, 50, m_hwnd, NULL);
		return 0;
...
LRESULT Button_Google::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	switch (uMsg)
	{
...
LRESULT Button_Center::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	switch (uMsg)
	{
...
LRESULT Button_Telegram::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	switch (uMsg)
	{
