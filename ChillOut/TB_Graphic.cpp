...
void Button_Notice::Draw_GrapgicResources()
{
    RECT Client_Rect;
    GetClientRect(m_hwnd, &Client_Rect);
...
void ToolBar::Send_GraphicResources()
{
    ...
    BT_Notice.m_pRenderTarget = m_pRenderTarget;
    BT_Notice.m_pSolBrush_text_half = m_pSolBrush_text_half;
    BT_Notice.m_pSolBrush_toolbar_button_search = m_pSolBrush_toolbar_button_search;
}